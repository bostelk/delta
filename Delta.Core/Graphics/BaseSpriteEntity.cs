...
namespace Delta.Graphics
{
    public abstract class BaseSpriteEntity : TransformableEntity
    {
        ...
        /// </summary>
        [ContentSerializerIgnore, Description("The size of the game object before it's scaled."), Category("Transform"), Browsable(true), ReadOnly(true)]
        ...
        /// </summary>
        [ContentSerializerIgnore, Description("The source rectangle of the game object.\nDefault is (0, 0, 0, 0)."), Category("Sprite"), DefaultValue(typeof(Rectangle), "0,0,0,0")]
        ...
        /// </summary>
        [ContentSerializer, Description("The sprite effects of the game object.\nDefault is None."), Category("Sprite"), DefaultValue(SpriteEffects.None), Editor(typeof(Delta.Editor.FlagEnumUIEditor), typeof(System.Drawing.Design.UITypeEditor))]
