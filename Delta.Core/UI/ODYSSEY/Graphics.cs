...
//        public static ShapeDescriptor DrawCircularOutline(Vector2 center, float radius, int slices, int width, Color color)
//        {
...
//        {
//            return DrawEllipse(center, radius1, radius2, Geometry.DegreeToRadian(0), Geometry.DegreeToRadian(360), slices, color);
//        }
...
//        {
//            return DrawFullRectangle(position, size, color, shadeMode, borderSize, borderColor, style, Border.All);
//        }

//        public static ShapeDescriptor DrawFullRectangle(Vector2 position, Size size, Color color, ShadingMode shadeMode,
//            int borderSize, Color borderColor, BorderStyle style, Border borders)
//        {
//            return ShapeDescriptor.Join(
...
//            vertices[2] = new CustomVertex.TransformedColored(topLeft.X + size.Width, topLeft.Y + size.Height, 0, 1, colorBottomRight);
...
//        public static ShapeDescriptor DrawRectangularOutline(Vector2 position,
//            Size size, Color borderTopAndLeft, Color borderBottomAndRight, int borderSize,
//            Border borders)
//        {
...
//            int triangleWidth, bool isTriangleUpside, Color color, int borderSize, Color borderColor,
...
//                    sTriangleSide = DrawLine(borderSize,
//                        Color.FromArgb(255, ColorOperator.Scale(borderColor, darkShadeFactor)),
//                        new Vector2(topLeft.X - triangleWidth + borderSize, topLeft.Y + (borderSize / 2)),
//                        new Vector2(topLeft.X + borderSize, topLeft.Y + innerSize.Height + (borderSize / 2)));
...
//                        new Vector2(topLeft.X + size.Width + triangleWidth, topLeft.Y + size.Height - (borderSize / 2)));

//                if ((triangleBorders & Border.Bottom) == Border.Bottom)
//                    sTriangleBase = DrawRectangle(new Vector2(topLeft.X + size.Width, topLeft.Y + size.Height - borderSize),
//                        new Size(triangleWidth, borderSize),
//                        Color.FromArgb(255, ColorOperator.Scale(borderColor, darkShadeFactor)));
//            }
//            else
...
//                    sTriangleSide = DrawLine(borderSize,
//                        Color.FromArgb(255, ColorOperator.Scale(borderColor, darkShadeFactor)),
//                        new Vector2(topLeft.X + innerSize.Width, position.Y + size.Height - (borderSize / 2)),
//                        new Vector2(topLeft.X + innerSize.Width + triangleWidth, position.Y + (borderSize / 2)));
...
//            vertices[0] = new CustomVertex.TransformedColored(topLeft.X, topLeft.Y, 0, 1, colorTopLeft);
//            vertices[1] = new CustomVertex.TransformedColored(topLeft.X, topLeft.Y + innerSize.Height, 0, 1, colorBottomleft);
//            vertices[2] = new CustomVertex.TransformedColored(topLeft.X + innerSize.Width, topLeft.Y + innerSize.Height, 0, 1, colorBottomRight);
//            vertices[3] = new CustomVertex.TransformedColored(topLeft.X + innerSize.Width, topLeft.Y, 0, 1, colorTopRight);

//            if (isTriangleUpside)

//                vertices[4] = new CustomVertex.TransformedColored(topLeft.X + innerSize.Width + triangleWidth, topLeft.Y + innerSize.Height, 0, 1, colorBottomRight);
//            else
//               vertices[4] = new CustomVertex.TransformedColored(topLeft.X + innerSize.Width + triangleWidth, topLeft.Y, 0, 1, colorTopRight);
...
//        public static ShapeDescriptor DrawEquilateralTriangle(Vector2 leftVertex, float sideLength, Color color,  bool isShaded, bool isTriangleUpside)
//        {
...
//            vertices[2] = new CustomVertex.TransformedColored(leftVertex.X + sideLength / 2, leftVertex.Y + heightOffset, 0, 1, col1);
